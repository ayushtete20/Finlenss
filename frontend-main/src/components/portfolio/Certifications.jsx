...
export const Certifications = () => {
  ...
  return (
    <section id="certifications" className="py-16 md:py-24 bg-[#EAF2F8] border-t border-[#BFDBFE] relative rounded-3xl">
              ...
              >
                ...
                <div className="pt-4 mt-4 border-t border-[#BFDBFE]/60 flex items-center justify-between">
                  ...
                  {hasAsset ? (
                    <button
                      type="button"
                      className="px-3 py-1 rounded-lg bg-[#1E3A8A] text-white hover:bg-[#2563EB] text-xs font-bold transition-all flex items-center gap-1.5 shadow-sm cursor-pointer"
                    >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#1E3A8A]/50 backdrop-blur-md">
          <div className="bg-white border border-[#BFDBFE] rounded-2xl max-w-2xl w-full p-6 sm:p-8 space-y-6 shadow-2xl relative max-h-[90vh] overflow-y-auto">
            ...
            <button
              ...
              className="absolute top-5 right-5 p-2 rounded-full text-[#475569] hover:bg-[#EFF6FF] hover:text-[#1E3A8A] transition-colors cursor-pointer"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            {(selectedCert.excelUrl || selectedCert.article_id) && (
              <div className="pt-4 border-t border-[#BFDBFE] flex flex-col sm:flex-row items-center gap-3">
                {selectedCert.excelUrl && (
                  <a
                    href={selectedCert.excelUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    download={selectedCert.excel_name || 'Financial_Model.xlsx'}
