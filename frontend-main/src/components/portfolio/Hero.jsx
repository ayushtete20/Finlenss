...
import { Eye, TrendingUp, Sparkles, Target, CheckCircle2, ArrowRight } from 'lucide-react';
...
export const Hero = () => {
  ...
  return (
    <section id="about" className="relative overflow-hidden py-16 md:py-24 bg-[#EAF2F8] rounded-3xl">
          ...
          >
            ...
            <div className="pt-4">
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#1E3A8A] hover:bg-[#1d4ed8] active:scale-95 text-white text-xs font-bold shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer"
              >
