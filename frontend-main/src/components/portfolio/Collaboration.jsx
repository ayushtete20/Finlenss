...
import { Mail, Send, CheckCircle2, Loader2, AlertCircle, Sparkles, MessageSquare, Briefcase } from 'lucide-react';
import { createCollaboration } from '../../services/api';
...
export const Collaboration = () => {
  ...
  return (
    <section id="collaborate" className="py-16 md:py-24 bg-[#EAF2F8] border-t border-[#BFDBFE] relative rounded-3xl">
