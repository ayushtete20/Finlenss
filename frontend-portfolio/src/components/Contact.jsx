...
export const Contact = () => {
  ...
  return (
    <section id="contact" className="py-16 md:py-24 bg-[#EAF2F8] border-t border-[#BFDBFE] relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 relative z-10">
        ...
        >
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-6">
            ...
            {submitted ? (
              <div className="p-6 rounded-xl bg-emerald-50 border border-emerald-300 text-emerald-900 space-y-2 text-center animate-fade-in">
