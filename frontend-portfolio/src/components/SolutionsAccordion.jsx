...
import { ChevronDown, Sparkles, TrendingUp, Cpu, ShieldCheck, FileText } from 'lucide-react';
...
export const SolutionsAccordion = () => {
  ...
  return (
    <section id="solutions" className="py-16 md:py-24 bg-[#EAF2F8] border-t border-[#BFDBFE] relative">
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="w-full p-6 text-left flex items-center justify-between gap-4 focus:outline-none bg-white hover:bg-[#EFF6FF]/60 transition-colors"
                >
